    ...
    return (
        <>
            ...
            <div className="bg-slate-100 w-[99.9vw] mb-2">
                ...
                <div className="bg-white p-4 flex w-[85vw] items-center m-auto mt-2 overflow-x-hidden no-scrollbar">
                ...
                <div className="bg-white p-4 flex w-[85vw] items-center mx-auto ">
                    <FundamentalPage />
                </div>
                <div className="bg-white p-4 w-[85vw] flex mx-auto flex-col items-start mt-2">
                ...
                <div className="bg-white p-4 w-[85vw] flex flex-col items-start mx-auto overflow-x-auto no-scrollbar">
                ...
                <div className="bg-white m-auto w-[85vw] flex items-center overflow-x-auto no-scrollbar p-2 mt-[2rem]">
                ...
                <div className="bg-white p-4 flex w-[85vw] items-center mx-auto mt-2 ">
                    <TeamPage />
                </div>
                <div>
